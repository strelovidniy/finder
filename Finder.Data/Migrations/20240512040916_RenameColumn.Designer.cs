...
namespace Finder.Data.Migrations
{
    ...
    [Migration("20240512040916_RenameColumn")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Finder.Data.Entities.NotificationSettings", b =>
                {
                    ...
                    b.Property<string>("FilterTitles")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Finder.Data.Entities.OperationLocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("OperationLocation", "dbo");
                });
            ...
            modelBuilder.Entity("Finder.Data.Entities.Role", b =>
                {
                    ...
                    b.Property<bool>("CanCreateSearchOperation")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("Finder.Data.Entities.UserSearchOperation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Finder.Data.Entities.OperationLocation", b =>
                {
                    b.HasOne("Finder.Data.Entities.SearchOperation", "SearchOperation")
                        .WithMany("OperationLocations")
                        .HasForeignKey("SearchOperationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SearchOperation");
                });
            ...
            modelBuilder.Entity("Finder.Data.Entities.SearchOperation", b =>
                {
                    b.HasOne("Finder.Data.Entities.User", "Creator")
            ...
            modelBuilder.Entity("Finder.Data.Entities.User", b =>
                {
                    ...
                    b.Navigation("UserSearchOperations");
                });
